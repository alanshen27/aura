    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 flex-col items-end gap-2">
          ...
          <span className="rounded-full bg-gradient-to-r from-accent to-pop-purple px-4 py-1.5 text-xs font-medium text-white shadow-sm transition-all group-hover:shadow-md group-hover:shadow-accent/20 group-hover:scale-105">
            start →
          </span>
        </div>
      </div>
