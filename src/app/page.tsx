...
import { DNAHelix, Flask, Cell, Plasmid, Protein, PetriDish } from "@/components/illustrations";
import FloatingBg from "@/components/illustrations/FloatingBg";

export default function Home() {
  return (
    <div>
      {/* Full-bleed hero (iGEM-wiki inspired) */}
      <section className="relative overflow-hidden bg-charcoal py-20 sm:py-28">
        <FloatingBg />

        <div className="relative mx-auto max-w-3xl px-6 text-center">
          {/* Animated illustration cluster */}
          <div className="mx-auto mb-10 flex items-center justify-center gap-5 opacity-70">
            <DNAHelix size={72} className="hidden animate-fade-in sm:block" />
            <div className="grid w-24 grid-cols-2 gap-1.5 animate-fade-in-up">
              <div className="flex aspect-square items-center justify-center rounded-md bg-white/10">
            ...
            <Flask size={72} className="hidden animate-fade-in sm:block" />
          </div>

          <h1 className="mb-6 text-3xl leading-tight tracking-tight text-white sm:text-4xl animate-fade-in-up">
            Learn synthetic biology
            <br />
            in small, clear modules.
          </h1>

          <p className="mx-auto mb-4 max-w-lg text-base leading-relaxed text-white/70 animate-fade-in-up">
            No science background needed. Just curiosity.
          </p>

          <p className="mx-auto mb-10 max-w-lg text-sm leading-relaxed text-white/40 animate-fade-in-up">
            We break complex topics into short, friendly lessons. Each module
            stands on its own, so you can learn at your own pace.
          </p>

          <div className="flex items-center justify-center gap-4 animate-fade-in-up">
            <Link
              href="/learn"
              className="group inline-flex items-center gap-2 rounded-lg bg-accent px-8 py-3 text-sm tracking-wide text-white transition-all hover:bg-accent-dark hover:gap-3"
            >
              Start Learning
              <svg
            ...
            <Link
              href="/newsletter"
              className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-6 py-3 text-sm text-white/70 transition-all hover:border-white/40 hover:text-white"
            >
              Get 3-min updates
            </Link>
          </div>
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <section className="pb-16 pt-4">
          <h2 className="mb-6 text-center text-xs uppercase tracking-wider text-muted">
            Why learn here?
          </h2>
